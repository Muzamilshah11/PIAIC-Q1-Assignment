...
const name_array = ['khan', 'shah', 'Ali'];
name_array.forEach((name) => console.log("Task 11:#", name));
//                //parameter called it
// Task 12:########     Greetings in Array     ############
let Greeting_Person = ['Shahin Shah', 'Jamal khan', 'Salman Shah', 'Sabir Ali', 'Ali Khan', 'Bilal khan', 'Dawood Shah', 'Zulfiqar Khan'];
let message = "Hello, and Good morning Mr.";
...
let list_updated = ['kamal khan', 'Gul Mateen', 'Shahjahan', 'Watan khan'];
...
const visit_place = ['Pakistan', 'UAE', 'China', 'Itly'];
